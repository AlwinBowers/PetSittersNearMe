...
define( 'DB_NAME', '755869b892_database' );

/** Database username */
//define( 'DB_USER', 'root' );
define( 'DB_USER', 'petsitters-755869b892-wpidentity' );

/** Database password */
//define( 'DB_PASSWORD', 'root' );
define( 'DB_PASSWORD', 'Cdb1933#' );

/** Database hostname */
//define( 'DB_HOST', 'localhost' );
define( 'DB_HOST', '755869b892-dbserver.mysql.database.azure.com' );
